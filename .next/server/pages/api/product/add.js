...
/******/ 	return __webpack_require__(__webpack_require__.s = "./pages/api/product/add.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_connectDB__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/utils/connectDB */ \"./utils/connectDB.js\");\n/* harmony import */ var _models_product__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/models/product */ \"./models/product.js\");\n\n\nObject(_utils_connectDB__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n/* harmony default export */ __webpack_exports__[\"default\"] = (async function (req, res) {\n  const {\n    image,\n    name,\n    price,\n    countInStock,\n    description,\n    brand,\n    category\n  } = req.body;\n  if (!image || !name || !price || !countInStock || !description) return res.status(404).json({\n    msg: 'Please fill all fields with correct information.'\n  });\n\n  try {\n    const product = new _models_product__WEBPACK_IMPORTED_MODULE_1__[\"default\"](req.body);\n    await product.save();\n    const products = await _models_product__WEBPACK_IMPORTED_MODULE_1__[\"default\"].find();\n    return res.json({\n      product: product,\n      products: products\n    });\n  } catch (err) {\n    res.status(500).json({\n      msg: 'Server Error',\n      error: err.message\n    });\n  }\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./pages/api/product/add.js\n");
